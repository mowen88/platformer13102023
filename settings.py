...
DATA = {
	'guns':{
			'blaster': {'ammo_type': None, 'bullet_type': 'projectile', 'cooldown': 30, 'speed': 4, 'damage': 50, 'path': '../assets/weapons/blaster.png', 'length':18, 'auto':False},
			'shotgun': {'ammo_type': 'shells', 'bullet_type': 'bullet', 'cooldown': 80, 'speed': 0, 'damage': 50, 'path': '../assets/weapons/shotgun.png', 'length':25, 'auto':False},
			'grenade': {'ammo_type': 'grenade', 'bullet_type': 'projectile', 'cooldown': 180, 'speed': 0, 'damage': 100, 'path': '../assets/weapons/grenade.png', 'length':15, 'auto':False},
